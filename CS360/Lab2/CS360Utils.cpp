...
CS360Utils::CS360Utils(){}
CS360Utils::~CS360Utils(){}

// Determine if the character is whitespace
bool CS360Utils::isWhitespace(char c)
{
    switch (c)
    {
        case '\r':
...
void CS360Utils::chomp(char *line)
{
    int len = strlen(line);
...
char * CS360Utils::GetLine(int fds)
{
...
void CS360Utils::UpcaseAndReplaceDashWithUnderline(char *str)
{
    int i;
    char *s;
...
// of the conversion
char * CS360Utils::FormatHeader(char *str, const char *prefix)
{
...
void CS360Utils::GetHeaderLines(vector<char *> &headerLines, int skt, bool envformat)
{
